...
This model demonstrates how MapReduce can be used in order to sort input data

## HOW IT WORKS

Both mapper and reducer are identity functions. The sorting is done by the MapReduce framework

## HOW TO USE IT

Select the dataset and click on Sort
